			...
			<TD width="100%">
				...
				<legend>项目信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><input name='projectName' type="text" class="text" style="width:154px" value="<%=p.getProjectname() %>" />
				        <span class="red">*</span></td>
				        	
					    <td nowrap align="right" width="18%">所属单位:</td>
					    <td width="35%"><select name="customerId" style="width:150px">
					    ...
					    <td width="35%"><input name='amt' type="text" class="text" style="width:154px" value="<%=p.getAmt()%>" />				        </td>
				         <td nowrap align="right" width="18%">开发人数:</td>
					    <td width="35%"><input name='workerCount' type="text" class="text" style="width:154px" value="<%=p.getWorkerCount() %>" />				        </td>	
						</tr>
						<tr>	
						...
						<tr>
							...
							<td><input name='buildDate' type="text" class="text" style="width:154px" value="<%=p.getBuilddate() %>" />                            </td>
